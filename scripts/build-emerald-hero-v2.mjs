...
.r2-hero{height:calc(100svh - 66px);min-height:610px;padding:24px 0;border-bottom:1px solid var(--line);position:relative;overflow:hidden;background:radial-gradient(60% 70% at 78% 24%,rgba(5,150,105,.10),transparent 72%)}
.r2-hero .wrap{height:100%;display:flex;align-items:center}.r2-shell{width:100%;display:grid;grid-template-columns:minmax(0,.88fr) minmax(500px,1.12fr);grid-template-rows:auto auto;column-gap:54px;row-gap:22px;align-items:center}
.r2-copy{align-self:end}.r2-copy h1{font-family:var(--display);font-weight:600;font-size:clamp(46px,5.5vw,72px);line-height:.98;letter-spacing:-.045em;max-width:10.6ch}.r2-copy h1 em{font-style:normal;background:linear-gradient(135deg,#047857,#34d399);-webkit-background-clip:text;background-clip:text;color:transparent}
.r2-demo{grid-column:2;grid-row:1 / span 2;align-self:center}.r2-card{height:392px;border:1px solid rgba(5,150,105,.22);border-radius:22px;background:rgba(255,255,255,.96);overflow:hidden;box-shadow:0 34px 90px -48px rgba(4,120,87,.58),0 18px 42px -30px rgba(18,18,18,.4)}
.r2-top{height:44px;padding:0 14px;display:flex;align-items:center;gap:9px;border-bottom:1px solid var(--line);background:linear-gradient(180deg,#fff,#f8faf9);font-family:var(--mono);font-size:9.5px;color:var(--mut2)}.r2-lights{display:flex;gap:6px}.r2-lights i{width:7px;height:7px;border-radius:50%;background:var(--wash3)}.r2-agent{display:flex;align-items:center;gap:6px;color:#047857;font-weight:700}.r2-agent i{width:6px;height:6px;border-radius:50%;background:#059669;box-shadow:0 0 0 4px #ecfdf5}.r2-state{margin-left:auto;border:1px solid #a7f3d0;background:#ecfdf5;color:#047857;border-radius:999px;padding:3px 7px;font-weight:700}
.r2-op{margin:13px 14px 0;padding:10px 11px;border:1px solid #a7f3d0;background:#ecfdf5;border-radius:11px;display:flex;align-items:center;gap:9px}.r2-op b{font-family:var(--mono);font-size:8px;letter-spacing:.08em;text-transform:uppercase;color:#047857}.r2-op span{font-size:11.5px;font-weight:600;min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
.r2-body{display:grid;grid-template-columns:162px 1fr;gap:12px;padding:12px 14px 10px;height:274px}.r2-flow{position:relative;padding-top:1px}.r2-flow::before{content:"";position:absolute;left:11px;top:13px;bottom:13px;width:1px;background:var(--line)}.r2-step{position:relative;display:flex;align-items:flex-start;gap:8px;min-height:49px;color:var(--mut2);transition:color .2s,transform .2s}.r2-dot{position:relative;z-index:1;width:23px;height:23px;flex:0 0 23px;border-radius:50%;display:grid;place-items:center;border:1px solid var(--line);background:#fff;font:700 8px var(--mono);transition:.2s}.r2-step strong{display:block;font-size:10.5px;line-height:1.2;color:inherit}.r2-step small{display:block;font:8px/1.35 var(--mono);margin-top:2px;color:var(--mut2)}.r2-step.is-active{color:#121212;transform:translateX(2px)}.r2-step.is-active .r2-dot{background:#ecfdf5;border-color:#059669;color:#047857;box-shadow:0 0 0 4px rgba(5,150,105,.08)}.r2-step.is-done .r2-dot{background:var(--accent-grad);border-color:#047857;color:#fff}.r2-step.is-done{color:#4b5563}
.r2-detail{border:1px solid var(--line);border-radius:14px;background:#fff;overflow:hidden;position:relative}.r2-detail-head{height:34px;padding:0 10px;border-bottom:1px solid var(--line2);display:flex;align-items:center;font:8.5px var(--mono);color:var(--mut2);background:#fafafa}.r2-detail-head span:last-child{margin-left:auto;color:#047857}.r2-scene{padding:13px 14px;opacity:1;transform:none;transition:opacity .18s ease,transform .22s ease}.r2-scene.out{opacity:0;transform:translateY(5px)}.r2-k{font:700 8px var(--mono);letter-spacing:.11em;text-transform:uppercase;color:#047857}.r2-scene h3{font:600 18px/1.08 var(--display);letter-spacing:-.025em;margin:7px 0 7px}.r2-scene p{font-size:10.5px;line-height:1.45;color:var(--mut);margin:0}.r2-metric{margin-top:12px;border-radius:10px;background:#f6f7f6;padding:9px 10px;min-height:68px}.r2-line{display:flex;align-items:center;gap:8px;font-size:10px}.r2-line+.r2-line{margin-top:6px}.r2-badge{margin-left:auto;font:700 7.5px var(--mono);border:1px solid var(--line);border-radius:999px;padding:2px 6px;color:var(--mut2);white-space:nowrap}.r2-badge.green{border-color:#a7f3d0;background:#ecfdf5;color:#047857}.r2-mail{font-size:9.5px;line-height:1.45;color:#333}.r2-mail b{color:#121212}.r2-result{display:flex;align-items:flex-end;gap:9px}.r2-big{font:700 34px/1 var(--display);letter-spacing:-.05em;color:#047857}.r2-up{font:700 9px var(--mono);color:#047857;margin-bottom:4px}
.r2-progress{height:3px;background:var(--wash2)}.r2-progress span{display:block;height:100%;width:0;background:var(--accent-grad);transition:width .25s ease}
.r2-start{align-self:start;display:flex;gap:8px;width:min(100%,470px)}.r2-start input{min-width:0;flex:1;height:50px;border:1px solid rgba(18,18,18,.15);border-radius:999px;padding:0 17px;font:14px var(--body);outline:none;background:#fff;box-shadow:0 12px 30px -26px rgba(18,18,18,.45)}.r2-start input:focus{border-color:#059669;box-shadow:0 0 0 3px rgba(5,150,105,.11)}.r2-start button{height:50px;border:0;border-radius:999px;padding:0 18px;background:var(--accent-grad);color:#fff;font:600 13.5px var(--body);cursor:pointer;white-space:nowrap}.r2-start button:hover{transform:translateY(-1px)}.r2-start-note{grid-column:1;font:9px var(--mono);color:var(--mut2);margin-top:-14px}
@media(max-width:900px){.r2-hero{height:calc(100svh - 66px);min-height:560px;padding:12px 0 10px;overflow:hidden}.r2-hero .wrap{align-items:stretch}.r2-shell{grid-template-columns:1fr;grid-template-rows:auto minmax(0,1fr) auto auto;row-gap:9px;height:100%;align-items:stretch}.r2-copy{grid-row:1;align-self:center;text-align:center}.r2-copy h1{font-size:clamp(37px,10.7vw,50px);line-height:.96;max-width:12ch;margin:0 auto}.r2-demo{grid-column:1;grid-row:2;min-height:0}.r2-card{height:100%;min-height:286px;max-height:332px;border-radius:17px}.r2-top{height:36px}.r2-op{margin:8px 9px 0;padding:7px 8px}.r2-body{grid-template-columns:115px 1fr;gap:7px;padding:8px 9px 7px;height:calc(100% - 80px)}.r2-step{min-height:41px;gap:6px}.r2-dot{width:20px;height:20px;flex-basis:20px}.r2-step strong{font-size:9px}.r2-step small{font-size:7px}.r2-flow::before{left:9px}.r2-detail{border-radius:11px}.r2-detail-head{height:28px;font-size:7.5px}.r2-scene{padding:9px 10px}.r2-scene h3{font-size:15px;margin:5px 0}.r2-scene p{font-size:9px}.r2-metric{margin-top:7px;padding:7px;min-height:52px}.r2-line{font-size:8.5px}.r2-line+.r2-line{margin-top:4px}.r2-big{font-size:28px}.r2-start{grid-row:3;width:100%;gap:6px}.r2-start input,.r2-start button{height:44px}.r2-start input{font-size:12.5px;padding:0 14px}.r2-start button{font-size:12px;padding:0 14px}.r2-start-note{grid-column:1;grid-row:4;text-align:center;margin:0;font-size:7.5px}}
@media(max-width:520px){.r2-shell{row-gap:7px}.r2-copy h1{font-size:clamp(34px,10.2vw,44px)}.r2-card{min-height:278px}.r2-op span{font-size:9.5px}.r2-body{grid-template-columns:101px 1fr}.r2-step small{display:none}.r2-start button{padding:0 12px}.r2-start button .r2-long{display:none}}
@media(max-height:720px) and (max-width:900px){.r2-hero{min-height:0}.r2-copy h1{font-size:34px}.r2-card{min-height:258px;max-height:286px}.r2-step{min-height:37px}.r2-start input,.r2-start button{height:40px}}
...
const HERO = String.raw`<header class="heroB r2-hero">
  <div class="wrap">
    <div class="r2-shell">
      <div class="r2-copy"><h1>Get your business found by <em>AI</em></h1></div>
      <div class="r2-demo">
...
(function(){
  ...
  function render(i,instant){
    ...
    state.textContent=s.state;head.textContent=s.head;headState.textContent=s.hs;progress.style.width=((i+1)/stages.length*100)+'%';
  ...
  function next(){clearTimeout(timer);var n=(current+1)%stages.length;if(n===0){steps.forEach(function(el,x){el.classList.remove('is-done');el.querySelector('.r2-dot').textContent=String(x+1)});progress.style.width='0%'}render(n,false);timer=setTimeout(next,durations[n]);}
  render(reduced?4:0,true);if(!reduced)timer=setTimeout(next,durations[0]);
  document.addEventListener('visibilitychange',function(){if(document.hidden){clearTimeout(timer)}else if(!reduced){timer=setTimeout(next,900)}});
